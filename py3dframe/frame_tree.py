...
class FrameTree:
    ...
    By default, the world frame is the default frame of the FrameTree.
    ...
    def get_compose_frame(
        ...
        >>> point_in_3 = frame_2_3.from_world_to_local(point=point_in_2) # Convert point from frame2 to frame3 
        ...
        inverse_input_frame = input_frame.get_inverse_frame() # Input -> World
