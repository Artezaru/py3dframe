...
def read_version():
    version_file = os.path.join(os.path.dirname(__file__), 'py3dframe', '__version__.py')
    with open(version_file) as f:
        exec(f.read()) 
    return locals()['__version__']

setup(
    name="py3dframe",  # Replace with your package name
    ...
    url="https://github.com/Artezaru/py3dframe.git",  # URL to the project repository
